...
**Live demo:** [ayushvardhanog.github.io/debate-partner](https://ayushvardhanog.github.io/debate-partner/)
...
docs/       — single-file UI (debate transcript + live scoreboard), served via GitHub Pages
```